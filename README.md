...
Cute Danceは踏み替え・顔まわりのポーズ・斜め上へのリーチをつないだ8カウントの
振り付けです。頭・肘・膝まで動かし、緩急と追従の遅れを付けています。
実写のモーションキャプチャではなく、固定10パーツで表現する2Dダンスです。
制作方法と表現上の限界は[CHOREOGRAPHY.md](docs/CHOREOGRAPHY.md)に記載しています。
